  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'linear-gradient(135deg, #022c22 0%, #0f172a 50%, #020617 100%)',
        'mesh-gradient': 'radial-gradient(at 40% 20%, #065f46 0px, transparent 50%), radial-gradient(at 80% 0%, #0f172a 0px, transparent 50%), radial-gradient(at 0% 50%, #022c22 0px, transparent 50%)',
      },
      boxShadow: {
